(function () {
  ...
  const NAV_PRIMARY = [
    ...
    { href: "/settings", id: "settings", label: "设置" },
  ];
  const NAV_SECONDARY = [
    ...
    { href: "/nai-tags", id: "nai-tags", label: "分类", group: "创作" },
    { href: "/progress", id: "progress", label: "爬虫", group: "采集" },
  ...
  function loadCompanionDock() {
    ...
    script.src = "/assets/shared/companion-dock.js?v=d6e285392f";
