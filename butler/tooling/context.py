...
class ToolContext:
    ...
    @classmethod
    def build(cls, registry: ToolRegistry, *, agent_id: str, source: str, round_index: int) -> "ToolContext":
        if not agent_id:
            raise ToolingError(
        ...
        return cls(agent_id=agent_id, source=source, round_index=round_index, allowed_names=allowed)
