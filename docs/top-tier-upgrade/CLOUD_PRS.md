...
- Worker: Lead
- Scope: Phase 0 continuation plus D-012..D-018 (compile, canvas, gallery HTTP, kernel chat, v1.9)
- Tests: see latest CI on PR #3; quality gate must stay `p1 == 0` without deleting tests
